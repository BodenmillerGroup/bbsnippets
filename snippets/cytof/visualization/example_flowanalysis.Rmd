...
dat_clusterannot[, cluster:= factor(cluster, levels=levels(cluster_pheno$cluster))]
...
p <- merge(cluster_dat, dat_clusterannot, by='cluster', all.x = TRUE) %>% 
...
p <- merge(cluster_dat, dat_clusterannot, by='cluster', all.x = T) %>%
